...
def parse_pabulib_from_string(file_content: str, sample_size: int | None = None) -> tuple[Instance, Profile]:
    """
...
def parse_pabulib(file_path: str, sample_size: int | None = None) -> tuple[Instance, Profile]:
    """
